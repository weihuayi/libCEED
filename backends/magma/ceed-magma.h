...
CEED_INTERN  void
magma_weight_nontensor(
    magma_int_t grid, magma_int_t threads, magma_int_t nelem,
    magma_int_t Q,
    CeedScalar *dqweight, CeedScalar *dv, magma_queue_t queue);

CEED_INTERN  void
magma_readDofsOffset(
    const magma_int_t NCOMP,
...
CEED_INTERN  void
magma_readDofsStrided(
    const magma_int_t NCOMP, const magma_int_t esize,
    const magma_int_t nelem, magma_int_t *strides,
    const CeedScalar *du, CeedScalar *dv,
    magma_queue_t queue);

CEED_INTERN  void
magma_writeDofsOffset(
    const magma_int_t NCOMP,
    const magma_int_t compstride,
    const magma_int_t esize, const magma_int_t nelem,
    magma_int_t *offsets,const CeedScalar *du, CeedScalar *dv,
...
CEED_INTERN int
    CeedBasisCreateH1_Magma(
    CeedElemTopology topo, CeedInt dim,
...
CEED_INTERN  int
CeedElemRestrictionCreate_Magma(
    CeedMemType mtype,
    CeedCopyMode cmode,
